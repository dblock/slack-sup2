...
describe SlackSup::Commands::Next do
  ...
  context 'dm' do
    let!(:channel1) { Fabricate(:channel, team:, sup_wday: wday, sup_time_of_day: (7 * 60 * 60) + 1, sup_tz: tz) }
    let!(:channel2) { Fabricate(:channel, team:, sup_wday: wday, sup_time_of_day: (9 * 60 * 60) + 1, sup_tz: tz) }
  ...
  context 'channel' do
    let(:channel) { Fabricate(:channel, channel_id: 'channel', team:, sup_wday: wday, sup_time_of_day: (7 * 60 * 60) + 1, sup_tz: tz) }
