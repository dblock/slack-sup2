...
describe SlackSup::Commands::Set do
  ...
  context 'in channel' do
    let!(:channel) { Fabricate(:channel, team:, channel_id: 'channel', sup_wday: Date::MONDAY, sup_followup_wday: Date::THURSDAY) }
    let(:admin) { Fabricate(:user, channel:, user_name: 'username', is_admin: true) }
    ...
    context 'admin' do
      ...
      it 'displays all settings' do
        expect(message: '@sup set').to respond_with_slack_message(
      ...
      context 'opt' do
        it 'shows current value when opted in' do
          ...
          expect(message: '@sup set opt').to respond_with_slack_message(
        ...
        it 'opts in' do
          channel.update_attributes!(opt_in: false)
          expect(message: '@sup set opt in').to respond_with_slack_message(
        ...
        it 'fails on an invalid opt value' do
          expect(message: '@sup set opt invalid').to respond_with_slack_message(
      ...
      context 'api' do
        it 'shows current value of API on' do
          ...
          expect(message: '@sup set api').to respond_with_slack_message(
            "Channel data access via the API is on.\n#{channel.api_url}"
          )
        end
        ...
        it 'enables API' do
          channel.update_attributes!(api: false)
          expect(message: '@sup set api on').to respond_with_slack_message(
        ...
        it 'disables API with set' do
          channel.update_attributes!(api: true)
          expect(message: '@sup set api off').to respond_with_slack_message(
      ...
      context 'api token' do
        it 'shows current value of API token' do
          ...
          expect(message: '@sup set api token').to respond_with_slack_message(
      ...
      context 'time' do
        it 'defaults to 9AM' do
          expect(message: '@sup set time').to respond_with_slack_message(
        ...
        it 'changes sup time' do
          expect(message: '@sup set time 11:20PM').to respond_with_slack_message(
        ...
        it 'errors set on an invalid time' do
          expect(message: '@sup set time foobar').to respond_with_slack_message(
      ...
      context 'weeks' do
        it 'defaults to one' do
          expect(message: '@sup set weeks').to respond_with_slack_message(
        ...
        it 'errors set on an invalid number of weeks' do
          expect(message: '@sup set weeks foobar').to respond_with_slack_message(
      ...
      context 'recency' do
        it 'defaults to one' do
          expect(message: '@sup set recency').to respond_with_slack_message(
        ...
        it 'errors set on an invalid number of weeks' do
          expect(message: '@sup set recency foobar').to respond_with_slack_message(
      ...
      context 'size' do
        it 'defaults to 3' do
          expect(message: '@sup set size').to respond_with_slack_message(
        ...
        it 'errors set on an invalid number of size' do
          expect(message: '@sup set size foobar').to respond_with_slack_message(
      ...
      context 'odd' do
        it 'shows current value of odd on' do
          ...
          expect(message: '@sup set odd').to respond_with_slack_message(
        ...
        it 'enables odd' do
          channel.update_attributes!(sup_odd: false)
          expect(message: '@sup set odd true').to respond_with_slack_message(
        ...
        it 'disables odd with set' do
          channel.update_attributes!(sup_odd: true)
          expect(message: '@sup set odd false').to respond_with_slack_message(
      ...
      context 'timezone' do
        it 'defaults to Eastern Time (US & Canada)' do
          expect(message: '@sup set timezone').to respond_with_slack_message(
        ...
        it 'changes timezone' do
          expect(message: '@sup set timezone Hawaii').to respond_with_slack_message(
        ...
        it 'errors set on an invalid timezone' do
          expect(message: '@sup set timezone foobar').to respond_with_slack_message(
      ...
      context 'time and time zone together' do
        it 'sets time together with a timezone' do
          expect(message: '@sup set time 10AM Hawaii').to respond_with_slack_message(
        ...
        it 'sets time together with a timezone' do
          expect(message: '@sup set time 10 AM Hawaii').to respond_with_slack_message(
            "Channel S'Up is now after 10:00 AM #{Time.now.in_time_zone(ActiveSupport::TimeZone.new('Hawaii')).strftime('%Z')}."
          )
          expect(channel.reload.sup_time_of_day).to eq 10 * 60 * 60
          expect(channel.reload.sup_tz).to eq 'Hawaii'
        ...
        it 'sets time together with a timezone' do
          expect(message: '@sup set time 10:00 AM Pacific Time (US & Canada)').to respond_with_slack_message(
      ...
      context 'custom profile team field', vcr: { cassette_name: 'team_profile_get' } do
        it 'is not set by default' do
          expect(message: '@sup set team field').to respond_with_slack_message(
            'Custom profile team field is _not set_.'
          )
        end
        ...
        it 'changes value' do
          expect(message: '@sup set team field Artsy Title').to respond_with_slack_message(
        ...
        it 'errors set on an invalid team field' do
          expect(message: '@sup set team field Invalid Field').to respond_with_slack_message(
        ...
        it 'unsets' do
          channel.update_attributes!(team_field_label: 'Artsy Team')
          expect(message: '@sup unset team field').to respond_with_slack_message(
      ...
      context 'custom sup message' do
        it 'is not set by default' do
          expect(message: '@sup set message').to respond_with_slack_message(
        ...
        it 'changes value' do
          expect(message: '@sup set message Hello world!').to respond_with_slack_message(
        ...
        it 'unsets' do
          ...
          expect(message: '@sup unset message').to respond_with_slack_message(
      ...
      context 'invalid' do
        it 'errors set' do
          expect(message: '@sup set invalid on').to respond_with_slack_message(
            'Invalid channel setting _invalid_, see _help_ for available options.'
          )
        end

        it 'errors unset' do
          expect(message: '@sup unset invalid').to respond_with_slack_message(
            'Invalid channel setting _invalid_, see _help_ for available options.'
          )
        end

        it 'errors rotate' do
          expect(message: '@sup rotate invalid').to respond_with_slack_message(
            'Invalid channel setting _invalid_, see _help_ for available options.'
          )
        end
      end
      ...
      context 'sync' do
        ...
        it 'shows next sync' do
          ...
          expect(message: '@sup set sync').to respond_with_slack_message(
        ...
        it 'errors on invalid sync value' do
          channel.update_attributes!(sync: false)
          expect(message: '@sup set sync foobar').to respond_with_slack_message(
    ...
    context 'not admin' do
      ...
      context 'api' do
        ...
        it 'can see timezone' do
          expect(message: '@sup set tz').to respond_with_slack_message(
            "Channel S'Up timezone is #{ActiveSupport::TimeZone.new('Eastern Time (US & Canada)')}."
          )
        end
  ...
  context 'dm' do
    ...
    context 'not an admin' do
      ...
      context 'set' do
        it 'displays all settings' do
          expect(message: '@sup set', channel: 'DM').to respond_with_slack_message(
            "S'Up is not enabled in any channels.\n" \
            "Team data access via the API is on.\n" \
            "#{team.api_url}"
          )
      ...
      context 'api' do
        it 'shows current value of API on' do
          team.update_attributes!(api: true)
          expect(message: '@sup set api', channel: 'DM').to respond_with_slack_message(
            "Team data access via the API is on.\n#{team.api_url}"
          )
        end
        ...
        it 'disables API with set' do
          team.update_attributes!(api: true)
          expect(message: '@sup set api off', channel: 'DM').to respond_with_slack_message(
      ...
      context 'api token' do
        it 'shows current value of API token' do
          team.update_attributes!(api_token: 'token', api: true)
          expect(message: '@sup set api token', channel: 'DM').to respond_with_slack_message(
