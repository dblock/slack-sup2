      ...
      class << self
        ...
        def unset_api_token(channel, data, user)
          if !channel.api?
            ...
            message = [
              channel_data_access_message(channel, user),
              "Only #{channel.channel_admins_slack_mentions.or} can unset it, sorry."
            ].join(' ')
            data.team.slack_client.chat_postMessage(channel: data.channel, text: message)
          end
        ...
        def rotate_api_token(channel, data, user)
          if !channel.api?
            ...
            message = [
              channel_data_access_message(channel, user),
              "Only #{channel.channel_admins_slack_mentions.or} can rotate it, sorry."
            ].join(' ')
            data.team.slack_client.chat_postMessage(channel: data.channel, text: message)
          end
        ...
        def set_day(channel, data, user, v = nil)
          if channel.is_admin?(user) && v
            ...
            data.team.slack_client.chat_postMessage(channel: data.channel, text: "Channel S'Up is on #{channel.sup_day}. Only #{channel.channel_admins_slack_mentions.or} can change that, sorry.")
          else
        ...
        def set_time(channel, data, user, v = nil)
          if channel.is_admin?(user) && v
            ...
            data.team.slack_client.chat_postMessage(channel: data.channel, text: "Channel S'Up is after #{channel.sup_time_of_day_s} #{channel.sup_tzone_s}. Only #{channel.channel_admins_slack_mentions.or} can change that, sorry.")
          else
        ...
        def set_followup_day(channel, data, user, v = nil)
          if channel.is_admin?(user) && v
            ...
            data.team.slack_client.chat_postMessage(channel: data.channel, text: "Channel S'Up followup day is on #{channel.sup_followup_day}. Only #{channel.channel_admins_slack_mentions.or} can change that, sorry.")
          else
        ...
        def set_weeks(channel, data, user, v = nil)
          if channel.is_admin?(user) && v
            ...
            data.team.slack_client.chat_postMessage(channel: data.channel, text: "Channel S'Up is every #{channel.sup_every_n_weeks_s}. Only #{channel.channel_admins_slack_mentions.or} can change that, sorry.")
          else
        ...
        def set_size(channel, data, user, v = nil)
          if channel.is_admin?(user) && v
            ...
            data.team.slack_client.chat_postMessage(channel: data.channel, text: "Channel S'Up connects groups of #{channel.sup_size} people. Only #{channel.channel_admins_slack_mentions.or} can change that, sorry.")
          else
        ...
        def set_timezone(channel, data, user, v = nil)
          if channel.is_admin?(user) && v
            ...
            data.team.slack_client.chat_postMessage(channel: data.channel, text: "Channel S'Up timezone is #{channel.sup_tzone}. Only #{channel.channel_admins_slack_mentions.or} can change that, sorry.")
          else
        ...
        def set_custom_profile_team_field(channel, data, user, v = nil)
          if channel.is_admin?(user) && v
            ...
            data.team.slack_client.chat_postMessage(channel: data.channel, text: "Custom profile team field is _#{channel.team_field_label || 'not set'}_. Only #{channel.channel_admins_slack_mentions.or} can change that, sorry.")
          else
        ...
        def set_message(channel, data, user, v = nil)
          if channel.is_admin?(user) && v
            ...
            data.team.slack_client.chat_postMessage(channel: data.channel, text: "Using a custom S'Up message. _#{channel.sup_message}_ Only #{channel.channel_admins_slack_mentions.or} can change that, sorry.")
          elsif v && !channel.sup_message
            data.team.slack_client.chat_postMessage(channel: data.channel, text: "Using the default S'Up message. _#{Sup::PLEASE_SUP_MESSAGE}_ Only #{channel.channel_admins_slack_mentions.or} can change that, sorry.")
        ...
        def set_recency(channel, data, user, v = nil)
          if channel.is_admin?(user) && v
            ...
            data.team.slack_client.chat_postMessage(channel: data.channel, text: "Taking special care to not pair the same people more than every #{channel.sup_recency_s}. Only #{channel.channel_admins_slack_mentions.or} can change that, sorry.")
          else
        ...
        def set_sync(channel, data, user, v = nil)
          if channel.is_admin?(user) && v
            ...
            data.team.slack_client.chat_postMessage(channel: data.channel, text: "#{channel.last_sync_at_text} Only #{channel.channel_admins_slack_mentions.or} can manually sync, sorry.")
          else
