...
* 2026/08/23: Preserved reverse proxy path prefixes in generated API links - [@oleksandr-bilyk](https://github.com/oleksandr-bilyk), [@Copilot](https://github.com/apps/copilot-swe-agent).
* 2026/08/23: Added MongoDB OIDC authentication using Azure Kubernetes workload identity - [@oleksandr-bilyk](https://github.com/oleksandr-bilyk), [@Copilot](https://github.com/apps/copilot-swe-agent).
* 2026/08/21: Added Docker-based local development using MongoDB running on the host - [@oleksandr-bilyk](https://github.com/oleksandr-bilyk), [@Copilot](https://github.com/apps/copilot-swe-agent).
...
* 2025/02/03: Fix: remove disabled users from channel admins - [@dblock](https://github.com/dblock).
